...
router.get('/getAllStocks', authentification, checkrole(['Admin','Manager', 'Client']), stockController.getAllStocks);

// 🔹 Stock d'un produit
router.get('/stockproduit/:ID_produit', authentification, checkrole(['Admin','Manager', 'Client']), stockController.getStockByProductID);

// 🔹 Stock d'une boutique
router.get('/stockboutique/:ID_boutique', authentification, checkrole(['Admin','Manager', 'Client']), stockController.getStockByBoutique);

// 🔹 Stock d'un produit dans une boutique (clé composite)
router.get('/stockproduitboutique/:ID_produit/:ID_boutique', authentification, checkrole(['Admin','Manager', 'Client']), stockController.getStockByProductAndBoutique);
