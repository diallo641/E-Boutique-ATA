...
//Modifier un manager
router.put('/updateManager/:id', authentification, checkrole(['Admin']), managerController.updatemanager);
...
router.get(
  '/getManagersByBoutique/:id',
  authentification,
  checkrole(['Admin','Manager']),
  managerController.getManagersByBoutique
);
