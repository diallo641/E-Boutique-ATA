...
import { useEditerCategorie } from "../JS/EditerCategorie";
import { Link } from "react-router-dom";

function EditerCategorie() {
  ...
  if (chargement && !formulaire.Nom_categorie) {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-xl mx-auto bg-white p-6 mt-10 rounded shadow">
        ...
        <form onSubmit={soumettreFormulaire} className="space-y-4">
          ...
          >
            {chargement ? "Modification..." : "Modifier la catégorie"}
          </button>
